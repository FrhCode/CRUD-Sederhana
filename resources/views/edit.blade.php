    ...
    <div class="container-fluid">
        <form method="POST" action="{{ route('Student.update',['Student'=>$student->id]) }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name" placeholder="Isikan nama disini" name="name" value="{{ $student->name }}">
            </div>
            <div class="mb-3">
                <label for="asalSekolah" class="form-label">Asal Sekolah</label>
                <input type="text" class="form-control" id="asalSekolah" placeholder="Isikan Asal Sekolah" name="school" value="{{ $student->school }}">
              </div>

            <div class="mb-3">
                <label for="address" class="form-label">Alamat</label>
                <textarea class="form-control" placeholder="Isikan Alamat disini" style="height: 100px" name="address">{{ $student->address }}</textarea>
            </div>
            <div class="mb-3">
